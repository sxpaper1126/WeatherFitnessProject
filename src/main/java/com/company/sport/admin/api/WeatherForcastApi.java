...
public class WeatherForcastApi {
    ...
    public String link ="http://apis.data.go.kr/1360000/VilageFcstInfoService_2.0/getUltraSrtFcst";
    ...
    public String getWeather(int nx, int ny) throws IOException {
        ...
        urlBuilder.append("&" + URLEncoder.encode("base_time","UTF-8") + "=" + URLEncoder.encode(baseTime,"UTF-8"));//baseTime
